...
void MotorTask::run() {
    ...
    for (;;) {
        ...
        //angle_output1 = angle_pid_down.calculate(target_angle1, motor_2.rotor_angle, 0.005f);
        speed_output1 = speed_pid_down.Calculate(target_angle1,motor_1.rotor_speed, 0.005f);

        //angle_output2 = angle_pid_up.Calculate(target_angle2, motor_2.rotor_angle, 0.005f);
