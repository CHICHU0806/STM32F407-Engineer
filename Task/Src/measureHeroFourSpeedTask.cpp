...
SpeedPID speed_pid3(1.0f, 0.02f, 0.003f, 5000.0f, 200.0f);
SpeedPID speed_pid4(1.0f, 0.02f, 0.003f, 5000.0f, 200.0f);
...
void HeroMeasureSpeedTask::run() {;
    ...
    for (;;) {
        motor1_cmd = speed_pid1.Calculate(5000, motor_1.rotor_speed, 0.005f);
        motor2_cmd = speed_pid2.Calculate(-5000, motor_2.rotor_speed, 0.005f);
